...
public class LoginController {
	...
	//request -> FrontController -> Controller -> Response(views - JSP)
	//Browse URL - http://localhost:8085/ims/
	@RequestMapping("/")
	...
	public String viewRegisterPage(Model model) {
		...
		return "register"; //It consist of model(dealer)+view(register)
	...
	public ModelAndView loginDealer(HttpServletRequest req,@ModelAttribute("dealer") Dealer dealer) {
        ...
        String s2 = st.nextToken(); //email id without domain
         ...
         Dealer d=lservice.findByEmail(email);   //fetch record/object from two tables based on email id
